              ...
              <div className="col">
                <ul className="nav nav-tabs nav-tabs-solid">
                  <li className="nav-item">
                    <Link className="nav-link  active" to="/user/blog-posted">
                      Bài viết đã gửi
                    </Link>
                  </li>
                  <li className="nav-item">
              ...
              <div key={post.id} className="col-md-6 col-xl-4 col-sm-12">
                <div className="blog grid-blog">
                  ...
                  <div className="row pt-3">
                    ...
                    <div className="col text-end"><a  className="text-danger" data-bs-toggle="modal" data-bs-target="#deleteNotConfirmModal"><i className="far fa-trash-alt" /> Xóa</a></div>
                  </div>
                </div>
              </div>
            ))}
