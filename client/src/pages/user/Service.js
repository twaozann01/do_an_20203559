                        ...
                        <div className="doctor-widget-one">
                          ...
                          <div className="doc-info-right">
                            <div className="clini-infos">
                              <ul>
                                <li>
                                  <i className="fas fa-thumbs-up available-icon" />{" "}
                                  98%
                                  <span className="votes">(252 Phiếu)</span>
                                </li>
                                <li>
                                    <p className="doc-location">
                          ...
                          <div className="doc-info-left">
                            ...
                            <div className="doc-info-cont">
                              ...
                              <div className="clinic-details">
                                <p className="doc-location">
                                  <i className="fas fa-map-marker-alt" />
                                  <span>0.9</span> km - Đông Anh, Hà Nội
                                </p>
                                <p className="doc-location">
                                  <i className="fas fa-award" /> <span>20</span>{" "}
                                  Năm kinh nghiệm
                          ...
                          <div className="doc-info-left">
                            ...
                            <div className="doc-info-cont">
                              ...
                              <div className="clinic-details">
                                <p className="doc-location">
                                  <i className="fas fa-map-marker-alt" />
                                  <span>0.9</span> km - Hồ Chí Minh
                                </p>
                                <p className="doc-location">
                                  <i className="fas fa-award" /> <span>12</span>{" "}
                                  Năm kinh nghiệm
                                </p>
                              </div>
                            </div>
