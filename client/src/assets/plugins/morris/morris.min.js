...
(function () {
  ...
  (b = window.Morris = {}),
    ...
    (b.Line = (function (a) {
      function c(a) {
        return (
          (this.highlight = f(this.highlight, this)),
      ...
      return (
        ...
        (c.prototype.displayHoverForRow = function (a) {
          ...
          return null != a
            ? ((b = this.hover).update.apply(b, this.hoverContentForRow(a)),
              this.highlight(a))
            : (this.hover.hide(), this.highlight());
        }),
        ...
        (c.prototype.highlight = function (a) {
          var b, c, d, e, f;
          if (null !== this.prevhighlight && this.prevhighlight !== a)
            for (
              b = c = 0, e = this.seriesPoints.length - 1;
              e >= 0 ? e >= c : c >= e;
              b = e >= 0 ? ++c : --c
            )
              this.seriesPoints[b][this.prevhighlight] &&
                this.seriesPoints[b][this.prevhighlight].animate(
                  this.pointShrinkSeries(b)
                );
          if (null !== a && this.prevhighlight !== a)
            for (
    ...
    (b.DonutSegment = (function (a) {
      function b(a, b, c, d, e, g, h, i, j, k) {
        ...
        (this.cx = a),
          ...
          (this.highlight = this.calcArc(this.inner));
      }
      return (
        h(b, a),
        ...
        (b.prototype.render = function () {
          var a = this;
          return (
            (this.arc = this.drawDonutArc(this.highlight, this.color)),
