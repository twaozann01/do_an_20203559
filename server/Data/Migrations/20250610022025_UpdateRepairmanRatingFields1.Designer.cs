...
namespace Data.Migrations
{
    ...
    [Migration("20250610022025_UpdateRepairmanRatingFields1")]
    partial class UpdateRepairmanRatingFields1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Shared.Entities.Order", b =>
                {
                    ...
                    b.Property<DateTime?>("FoundRepairmanAt")
                        .HasColumnType("timestamp without time zone");

                    b.Property<bool>("HasUpdatedRating")
                        .HasColumnType("boolean");
                    ...
                    b.Property<DateTime?>("RatingUpdatedDate")
                        .HasColumnType("timestamp without time zone");
            ...
            modelBuilder.Entity("Shared.Entities.WalletTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("VatConfig", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Shared.Entities.RepairmanFormDetail", b =>
                {
                    b.HasOne("Shared.Entities.RepairmanForm", "RepairmanForm")
                        .WithOne("Detail")
                        .HasForeignKey("Shared.Entities.RepairmanFormDetail", "RepairmanFormId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Shared.Entities.User", b =>
                {
                    b.OwnsMany("Shared.Models.RepairmanProfile", "RepairmanInfos", b1 =>
                        {
                            b1.Property<int>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("integer");
                            ...
                            b1.Property<Guid>("ServiceDeviceId")
                                .HasColumnType("uuid");
                            ...
                            b1.ToTable("RepairmanProfiles", (string)null);

                            b1.WithOwner()
                                .HasForeignKey("UserId");
                        });

                    b.Navigation("RepairmanInfos");
                });
